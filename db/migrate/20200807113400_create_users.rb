class CreateUsers < ActiveRecord::Migration[6.0]
  def change
    create_table :users do |t|
      t.string  :username, limit: 20, null: false, unique: true, default: ''
      t.string  :first_name, limit: 20, null: false,  unique: true, default: ' '
      t.string  :last_name, limit: 20, null: false,  unique: true, default: ' '
